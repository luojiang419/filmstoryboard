...
const onboardingSteps = <OnboardingStep>[
  OnboardingStep(
    ...
    body: '这段快速导览会带你认识视频解析、故事板、拍摄脚本复刻流程、导出和设置。你可以随时跳过，也能通过标题栏的帮助按钮重新查看。',
    tabIndex: 0,
  ),
  OnboardingStep(
    id: 'design',
  ...
  OnboardingStep(
    id: 'video-generation',
    section: OnboardingSection.videoGeneration,
    eyebrow: '第 5 步 · 视频生成',
    title: '用复刻分镜图批量生成视频',
    body: '按原视频 IO 点预览动作节奏，编辑可灵提示词，确认模型、时长和灵感值后生成；失败或超时不会自动重投。',
    tabIndex: 4,
  ),
  OnboardingStep(
    id: 'export',
