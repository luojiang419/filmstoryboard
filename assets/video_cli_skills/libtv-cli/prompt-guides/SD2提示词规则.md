...
<columns>
<columnsItem zoneid="yYQTWWBsxC">

<span>![图片](https://arkdocs.tos-cn-beijing.volces.com/flowcharts/video-generation/doubao-seedance-2-0-prompt-guide-01.svg) </span>

</columnsItem>
<columnsItem zoneid="sgCAgMSPkI">

<span>![图片](https://arkdocs.tos-cn-beijing.volces.com/flowcharts/video-generation/doubao-seedance-2-0-prompt-guide-02.svg) </span>

</columnsItem>
<columnsItem zoneid="jGjbOuKXaz">

<span>![图片](https://arkdocs.tos-cn-beijing.volces.com/flowcharts/video-generation/doubao-seedance-2-0-prompt-guide-03.svg) </span>

</columnsItem>
<columnsItem zoneid="vFyyFlTIYt">

<span>![图片](https://arkdocs.tos-cn-beijing.volces.com/flowcharts/video-generation/doubao-seedance-2-0-prompt-guide-04.svg) </span>
...
<Tabs>
<Tab zoneid="MS2aEuO4k7" title="基本定义方式">
...
<Tab zoneid="cU0PPV155m" title="多素材同主体">
...
<Tab zoneid="taGKhte6bS" title="多主体场景">
...
<Tabs>
<Tab zoneid="HbCyPA1RgD" title="示例1：宿舍情感短剧（偏文戏 / 对话）">
...
<Tab zoneid="XLZkC7GDdt" title="示例2：古风悬崖对手戏（偏动作/氛围）">
...
展示在不同场景下使用 Seedance 2.0 系列模型的提示词示例，帮助您更精准地实现多模态参考的指代控制及文字生成等功能。 更多优秀案例请参考 [控制台体验中心 Seedance2.0](https://console.volcengine.com/ark/region:ark+cn-beijing/experience/vision?modelId=doubao-seedance-2-0-260128&tab=GenVideo) 模板库。

<span>![图片](https://arkdocs.tos-cn-beijing.volces.com/images/video-generation/image-sd2.0template.png) </span>
